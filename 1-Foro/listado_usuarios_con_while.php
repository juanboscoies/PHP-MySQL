...
<?php
	...
	//usando while
	//pongo el puntero de nuevo a cero
	...
	//con un while recorro la tabla y por cada fila que haya se ejecuta
	...
	//imprimo en la tabla
		...
		echo "\t\t\t\t<td><a href=\"editar_ficha.php?id=$dato[0]\">Editar</a></td>\n";
		echo "\t\t\t\t</tr>\n";
	}
	echo "\t\t</table>\n";
...
?>
<!-- Ponemos un boton para la insercion de un nuevo usuario -->
<p> &nbsp; </p>
